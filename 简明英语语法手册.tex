...
这是两位中学生用\LaTeX{}技术编写的一本英语语法手册，如有错误请指出。
...
在中学，名词（n.）可以被简略地分为可数名词（Countable Noun cn.）和不可数名词（Uncountable Noun un.）
，其中可数名词指代可以用数目数清的名词，不可数名词指代无法用数目数清的名词。

\subsubsection{可数名词}

可数名词有单复数的变化。单数指一个该物体，复数指多个该物体。
因此名词常与数词，冠词等限制词（如a/an/the/my等）连用。在复数时无需限制词。
...
不及物动词本身可以表达完整的含义，故而不需要宾语，如果要接宾语，
则可以通过加上介词后接宾语，其与介词和及物动词的关系可以写成如下的公式：
...
系动词（Linking Verbs）是英语动词中最特殊的一类：它不表示动作，
而是说明主语的属性。在中学中可以被分成这几类：
